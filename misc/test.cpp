...
#define SAS_TOKEN "SharedAccessSignature sr=btHub1.azure-devices.net%2Fdevices%2Fbtesp32&sig=i%2F97KM2GGYYE1d0anFX2P2znEneddbfz2emZTsJj8PU%3D&se=1757013663"
...
void speaker_setup(){
    ...
    Positive to GPIO 
    */
    a2dp.set_volume(64);                  // 0..127 (~50% per AVRCP absolute volume)
    a2dp.set_on_volumechange(onVolumeChange);
    a2dp.start("J80");
